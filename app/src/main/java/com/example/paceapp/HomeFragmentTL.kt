...
import com.example.paceapp.databinding.HomeFragmentTlBinding


class HomeFragmentTL : Fragment(R.layout.home_fragment) {

    private lateinit var binding: HomeFragmentTlBinding
    ...
    override fun onCreateView(
        ...
        binding = HomeFragmentTlBinding.inflate(inflater, container, false)
        ...
        binding.addNewExpert.setOnClickListener()
