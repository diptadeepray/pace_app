...
import com.example.paceapp.databinding.AddExpertTlBinding
import com.google.firebase.firestore.FirebaseFirestore

class AddFreelancerTL : AppCompatActivity() {

    private lateinit var binding: AddExpertTlBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = AddExpertTlBinding.inflate(layoutInflater)
