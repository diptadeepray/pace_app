...
import com.example.paceapp.databinding.ActivityMainTlBinding
...
class MainActivityTL : AppCompatActivity() {


    private lateinit var binding: ActivityMainTlBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainTlBinding.inflate(layoutInflater)
